...
public class GainKnife {
    ...
    public static void bindSync(Activity target,OnGainAttachFinishCallback callback) {
        if (target == null) return;
        KnifeContainer.getInstance().setMainClass(target.getClass());
        Knife.findGainForKeyWordTargetSync(target,true,null,callback);
    }
     ...
     * @param target
     */
    public static void bindSync(Object target) {
        bindSync(target,null);
    }
     ...
     * @param target
     */
    public static void bindSync(Object target, OnGainAttachFinishCallback callback) {
        if (target == null) return;
        KnifeContainer.getInstance().setMainClass(target.getClass());
        Knife.findGainForKeyWordTargetSync(target,true,null,callback);
    }
    ...
    public static void registerUnableConstructorTarget(Object target, Class life) {
        ...
        Knife.findUnSupportConstructorGainForKeyWordTarget(target, life,false);
    }
    ...
    public static void unRegisterUnableConstructorTarget(Class targetCls) {
        ...
        LifecycleObservable.get().unAttachLifecycle(targetCls,false);
    }
     ...
     */
    @Deprecated
    public static void unRegisterUnableConstructorTargetSync(Class targetCls) {
        if(targetCls == null) return;
        KnifeContainer.getInstance().removeUnSupport(targetCls.getName());
        LifecycleObservable.get().unAttachLifecycle(targetCls,true);
    }
     ...
     * @param targetCls 被注册的类型
     */
    public static void unBindSync(Class targetCls) {
        if(targetCls == null) return;
        KnifeContainer.getInstance().unRelated(targetCls.getName());
        LifecycleObservable.get().unAttachLifecycle(targetCls,true);
    }
